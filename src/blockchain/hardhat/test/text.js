...
describe('MarketContract testing', async () =>  {
  ...
  beforeEach(async() => {
    ...
    await cosmoContract.connect(admin).authorizeOperator(marketPlaceContract.address)
  ...
  it('Should transfer NFT and pay royalties', async () => {
    ...
    await marketPlaceContract.buyItem(cosmoContract.address, 1, {value: ethers.utils.parseUnits('2', 'ether')})
